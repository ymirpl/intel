...
extern void* dealign (void* inputBMP, int width, int height);
...
int main(void) {
	...
	filter(input1, head[0].width, head[0].height, output1[4], 35, 35);
	filter(input2, head[1].width, head[1].height, output2[4], 35, 35);
	filter(input3, head[2].width, head[2].height, output3[0], 5, 5);
	filter(input4, head[3].width, head[3].height, output4[4], 35, 35);
